...
var _automatic = require('./engine/automatic');
...
var Auth0Lock = function (_Core) {
  ...
  function Auth0Lock(clientID, domain, options) {
    ...
    return _possibleConstructorReturn(this, _Core.call(this, clientID, domain, options, _automatic2.default));
  }
