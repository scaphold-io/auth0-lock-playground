...
var VcodePane = function (_React$Component) {
  ...
  VcodePane.prototype.handleResendClick = function handleResendClick(e) {
    ...
    var onRestart = _props.onRestart;
  ...
  VcodePane.prototype.render = function render() {
    ...
    var resendLabel = _props2.resendLabel;
...
VcodePane.propTypes = {
  instructions: _react2.default.PropTypes.element,
  ...
  onRestart: _react2.default.PropTypes.func.isRequired
};
