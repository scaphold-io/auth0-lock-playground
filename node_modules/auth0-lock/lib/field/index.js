...
function setField(m, field, value) {
  var validator = arguments.length <= 3 || arguments[3] === undefined ? function (str) {
...
function getField(m, field) {
  var notFound = arguments.length <= 2 || arguments[2] === undefined ? new _immutable.Map({}) : arguments[2];
