...
var Chrome = function (_React$Component2) {
  ...
  Chrome.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var auxiliaryPane = _props2.auxiliaryPane;
    var showSubmitButton = _props2.showSubmitButton;
  ...
  Chrome.prototype.render = function render() {
    ...
    var avatar = _props4.avatar;
    var auxiliaryPane = _props4.auxiliaryPane;
    var backHandler = _props4.backHandler;
    var contentComponent = _props4.contentComponent;
    var contentProps = _props4.contentProps;
    var disableSubmitButton = _props4.disableSubmitButton;
    var error = _props4.error;
    var isSubmitting = _props4.isSubmitting;
    var logo = _props4.logo;
    var primaryColor = _props4.primaryColor;
    var screenName = _props4.screenName;
    var showSubmitButton = _props4.showSubmitButton;
    var success = _props4.success;
    var terms = _props4.terms;
    var title = _props4.title;
    var transitionName = _props4.transitionName;
    var _state = this.state;
    var delayingShowSubmitButton = _state.delayingShowSubmitButton;
    var moving = _state.moving;
    var reverse = _state.reverse;
