...
var UsernameInput = function (_React$Component) {
  ...
  UsernameInput.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    return invalidHint != nextProps.invalidHint || isValid != nextProps.isValid || value != nextProps.value;
  };

  UsernameInput.prototype.render = function render() {
    var _props2 = this.props;
    var invalidHint = _props2.invalidHint;
    var isValid = _props2.isValid;
    var onChange = _props2.onChange;

    var props = _objectWithoutProperties(_props2, ['invalidHint', 'isValid', 'onChange']);
