...
var PasswordInput = function (_React$Component) {
  ...
  PasswordInput.prototype.render = function render() {
    ...
    var strengthMessages = _props.strengthMessages;
    var value = _props.value;

    var props = _objectWithoutProperties(_props, ['invalidHint', 'isValid', 'onChange', 'policy', 'strengthMessages', 'value']);

    var focused = this.state.focused;


    var passwordStrength = policy && focused ? _react2.default.createElement(_password_strength2.default, {
