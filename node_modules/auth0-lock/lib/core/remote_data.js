...
function syncRemoteData(m) {
  m = (0, _sync2.default)(m, "client", {
    syncFn: function syncFn(m, cb) {
      return (0, _settings.fetchClientSettings)(l.clientID(m), l.assetsUrl(m), cb);
    },
...
function syncClientSettingsSuccess(m, result) {
  result = _immutable2.default.fromJS(result);
  m = m.setIn(["core", "connections"], (0, _index.pickConnections)(result, l.allowedConnections(m)));

  m = m.setIn(["core", "hasFreeSubscription"], (0, _index.hasFreeSubscription)(result));
