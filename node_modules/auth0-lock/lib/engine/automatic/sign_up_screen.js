...
var Component = function Component(_ref) {
  ...
  var sso = (0, _automatic.isSSOEnabled)(model) && (0, _index.hasScreen)(model, "login");
...
var SignUp = function (_Screen) {
  ...
  SignUp.prototype.submitHandler = function submitHandler(m) {
    if ((0, _automatic.hasOnlyClassicConnections)(m, "social")) return null;
    if ((0, _automatic.isSSOEnabled)(m)) return _actions2.logIn;
