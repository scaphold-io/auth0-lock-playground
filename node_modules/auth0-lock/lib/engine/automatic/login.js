...
function shouldRenderTabs(m) {
  if ((0, _automatic.isSSOEnabled)(m)) return false;
...
var Component = function Component(_ref) {
  ...
  var sso = (0, _automatic.isSSOEnabled)(model);
  var onlySocial = (0, _automatic.hasOnlyClassicConnections)(model, "social");
  ...
  var social = l.hasSomeConnections(model, "social") && _react2.default.createElement(_social_buttons_pane2.default, {
    bigButtons: (0, _automatic.useBigSocialButtons)(model),
  ...
  var usernameInputPlaceholderKey = (0, _index.databaseUsernameStyle)(model) === "any" ? "usernameOrEmailInputPlaceholder" : "usernameInputPlaceholder";
  ...
  var login = (sso || l.hasSomeConnections(model, "database") || l.hasSomeConnections(model, "enterprise")) && _react2.default.createElement(_login_pane2.default, {
    ...
    usernameStyle: (0, _index.databaseUsernameStyle)(model)
  });
...
var Login = function (_Screen) {
  ...
  Login.prototype.submitHandler = function submitHandler(model) {
    if ((0, _automatic.hasOnlyClassicConnections)(model, "social")) {
      return null;
    }
    ...
    var useDatabaseConnection = !(0, _automatic.isSSOEnabled)(model) && (0, _index.databaseConnection)(model) && ((0, _index.defaultDatabaseConnection)(model) || !(0, _enterprise.defaultEnterpriseConnection)(model));
