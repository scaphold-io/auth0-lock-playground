...
var _login = require('./automatic/login');

var _login2 = _interopRequireDefault(_login);

var _sign_up_screen = require('./automatic/sign_up_screen');
...
var Automatic = function () {
  ...
  Automatic.prototype.didInitialize = function didInitialize(model, options) {
    ...
    if (typeof username === "string") model = (0, _username.setUsername)(model, username);

    return model;
  };

  Automatic.prototype.didReceiveClientSettings = function didReceiveClientSettings(m) {
  ...
  Automatic.prototype.render = function render(m) {
    ...
    var Screen = Automatic.SCREENS[(0, _index4.getScreen)(m)];
