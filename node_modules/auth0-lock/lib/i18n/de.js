...
exports.default = {
  error: {
    ...
    login: {
      ...
      "lock.invalid_code": "Falsche Code.",
      "lock.invalid_email_password": "Falsche E-Mail oder Passwort.",
      "lock.invalid_username_password": "Falsche Benutzername oder Passwort.",
      ...
      "password_change_required": "Sie müssen Ihrt Passwort ändern, da Sie sich zum ersten Mal anmelden oder das Passwort abgelaufen ist.",
      "password_leaked": "Sie müssen Ihrt Passwort ändern, da Sie sich zum ersten Mal anmelden oder das Passwort abgelaufen ist.",
  ...
  forgotPasswordInstructions: "Geben Sie bitte Ihre Email-Adresse ein. Wir werden Ihnen eine E-Mail senden Ihr Passwort zurücksetzen können.",
  ...
  resendCodeAction: "Haben Sie nicht den Code zu bekommen?",
